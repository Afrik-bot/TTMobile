  ...
  return (
    <div className="min-h-screen bg-gray-950 pb-20">
      <div className="max-w-lg mx-auto p-4">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-white mb-2">Tam Tam Live</h1>
          <p className="text-gray-400">Connect with your audience in real-time</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-gray-900 rounded-lg">
            ...
            <div className="h-48 overflow-y-auto bg-gray-950 rounded p-4">
